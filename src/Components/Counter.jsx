  ...
  return (
    <>
      ...
      <div className="text-center py-12 w-11/12 mx-auto dark:text-white">
        ...
        <p className="text-[14px] md:text-[18px] opacity-60 mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 justify-center md:">
          <div
            ...
            className="bg-white dark:bg-zinc-600 dark:text-white p-10 rounded-2xl shadow-blue-300 dark:shadow-zinc-900 shadow-2xl "
          >
            <img
